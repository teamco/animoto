...
(function ($) {
    $.fn.lifestream.feeds.facebookpage = function (config, callback) {
...
(function ($) {
    $.fn.lifestream.feeds.flickr = function (config, callback) {
        ...
        $.ajax({
            url: "https://api.flickr.com/services/feeds/photos_public.gne?id=" + config.user + "&lang=en-us&format=json",
            dataType: "jsonp",
            jsonp: 'jsoncallback',
            success: function (data) {
                var output = [],
        ...
        var template = $.extend({}, {
            ...
            parseGithubStatus = function (status) {
                if (status.type === 'CommitCommentEvent') {
                    return $.tmpl(template.commitCommentEvent, {
                        status: status
                    });
                } else if (status.type === 'CreateEvent' &&
                    status.payload.ref_type === 'branch') {
                    return $.tmpl(template.createBranchEvent, {
                        status: status
                    });
                } else if (status.type === 'CreateEvent' &&
                    status.payload.ref_type === 'repository') {
                    return $.tmpl(template.createRepositoryEvent, {
                        status: status
                    });
                } else if (status.type === 'CreateEvent' &&
                    status.payload.ref_type === 'tag') {
                    return $.tmpl(template.createTagEvent, {
                        status: status
                    });
                } else if (status.type === 'DeleteEvent' &&
                    status.payload.ref_type === 'branch') {
                    return $.tmpl(template.deleteBranchEvent, {
                        status: status
                    });
                } else if (status.type === 'DeleteEvent' &&
                    status.payload.ref_type === 'tag') {
                    return $.tmpl(template.deleteTagEvent, {
                        status: status
                    });
                } else if (status.type === 'FollowEvent') {
                    return $.tmpl(template.followEvent, {
                        status: status
                    });
                } else if (status.type === 'ForkEvent') {
                    return $.tmpl(template.forkEvent, {
                        status: status
                    });
...
(function ($) {
    $.fn.lifestream.feeds.stackoverflow = function (config, callback) {
        ...
        $.ajax({
            url: "https://api.stackexchange.com/2.1/users/" + config.user + "/timeline?site=stackoverflow",
            dataType: "jsonp",
            jsonp: 'jsonp',
            success: function (data) {
                var output = [];
...
(function ($) {
    $.fn.lifestream.feeds.wikipedia = function (config, callback) {
        ...
        $.ajax({
            url: "https://" + language + ".wikipedia.org/w/api.php?action=query&ucuser=" + config.user + "&list=usercontribs&ucdir=older&format=json",
            dataType: "jsonp",
            success: function (data) {
                var output = [],
                    i = 0,
    ...
    $.fn.lifestream.feeds.youtube = function (config, callback) {
        ...
        var template = $.extend({}, {
            ...
            parseYoutube = function (input, activity) {
                var output = [],
                    i = 0,
                    j, item, video, date, templateData;
        ...
        $.ajax({
            url: "https://gdata.youtube.com/feeds/api/users/" + config.user + "/favorites?v=2&alt=jsonc",
            dataType: 'jsonp',
            success: function (data) {
        ...
        $.ajax({
            url: "https://gdata.youtube.com/feeds/api/users/" + config.user + "/uploads?v=2&alt=jsonc",
            dataType: 'jsonp',
            success: function (data) {
