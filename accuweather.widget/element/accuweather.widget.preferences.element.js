...
defineP([
...
], function defineAccuweatherWidgetPreferencesElement(PluginElement,
    WidgetPreferences) {
   ...
   */
  var AccuweatherWidgetPreferencesElement = function AccuweatherWidgetPreferencesElement(view,
      opts) {
