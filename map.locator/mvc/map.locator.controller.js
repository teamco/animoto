...
defineP(
     ...
     * @returns {*}
     */
    function defineMapLocatorController(knob, BaseGeolocation, PluginController,
      ...
      return MapLocatorController.extend('MapLocatorController', {
            ...
            _setEmbeddedContent: function _setEmbeddedContent() {
              this.view.elements.$maplocator.renderEmbeddedContent({
                ...
                waterVisibility: this.model.getPrefs(
                    'maplocatorMapStyleWaterVisibility'),
                landscapeColor: this.model.getPrefs(
                    'maplocatorMapStyleLandscapeColor'),
                roadSaturation: this.model.getPrefs(
                    'maplocatorMapStyleRoadSaturation'),
                roadLightness: this.model.getPrefs(
                    'maplocatorMapStyleRoadLightness'),
                roadHighwayVisibility: this.model.getPrefs(
                    'maplocatorMapStyleRoadHighwayVisibility'),
                roadArterialElementType: this.model.getPrefs(
                    'maplocatorMapStyleRoadArterialElementType'),
                roadArterialVisibility: this.model.getPrefs(
                    'maplocatorMapStyleRoadArterialVisibility'),
                administrativeElementType: this.model.getPrefs(
                    'maplocatorMapStyleAdministrativeElementType'),
                administrativeColor: this.model.getPrefs(
                    'maplocatorMapStyleAdministrativeColor'),
                transitVisibility: this.model.getPrefs(
                    'maplocatorMapStyleTransitVisibility'),
                poiVisibility: this.model.getPrefs(
