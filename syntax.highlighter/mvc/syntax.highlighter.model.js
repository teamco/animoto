...
defineP([
  ...
  var SyntaxHighlighterModel = function SyntaxHighlighterModel() {
     ...
     * @type {{
         *      syntaxhighlighterCode: {type: string, disabled: boolean, value:
         *     undefined, visible: boolean}, syntaxhighlighterType: {type:
         *     string, disabled: boolean, list: Array, value: string, visible:
         *     boolean}
         * }}
     */
    this.preferences = {
    ...
    this.syntaxHighlighterData = {
      name: ['ActionScript3', 'Bash/shell', 'ColdFusion', 'C#', 'C++', 'CSS',
        'Delphi', 'Diff', 'Erlang', 'Groovy', 'JavaScript', 'Java', 'JavaFX',
        'Perl', 'PHP', 'Plain Text', 'PowerShell', 'Python', 'Ruby', 'Scala',
        'SQL', 'Visual Basic', 'XML'],
      alias: ['as3, actionscript3', 'bash, shell', 'cf, coldfusion',
        'c-sharp, csharp', 'cpp, c', 'css', 'delphi, pas, pascal',
        'diff, patch', 'erl, erlang', 'groovy', 'js, jscript, javascript',
        'java', 'jfx, javafx', 'perl, pl', 'php', 'plain, text',
        'ps, powershell', 'py, python', 'rails, ror, ruby', 'scala', 'sql',
        'vb, vbnet', 'xml, xhtml, xslt, html, xhtml'],
      file: ['shBrushAS3.js', 'shBrushBash.js', 'shBrushColdFusion.js',
        'shBrushCSharp.js', 'shBrushCpp.js', 'shBrushCss.js',
        'shBrushDelphi.js', 'shBrushDiff.js', 'shBrushErlang.js',
        'shBrushGroovy.js', 'shBrushJScript.js', 'shBrushJava.js',
        'shBrushJavaFX.js', 'shBrushPerl.js', 'shBrushPhp.js',
        'shBrushPlain.js', 'shBrushPowerShell.js', 'shBrushPython.js',
        'shBrushRuby.js', 'shBrushScala.js', 'shBrushSql.js', 'shBrushVb.js',
        'shBrushXml.js']
    };
