...
defineP([
...
], function defineFacebookEmbeddedPosts(AntHill, MVC, Controller, Model, View,
   ...
   * @extends AntHill
   */
  var FacebookEmbeddedPosts = function FacebookEmbeddedPosts(containment,
      opts) {
  ...
  return FacebookEmbeddedPosts.extend('FacebookEmbeddedPosts', {},
      AntHill.prototype);
});
