...
defineP([
...
], function defineFacebookEmbeddedPostsPreferencesElement(PluginElement,
    WidgetPreferences) {
   ...
   */
  var FacebookEmbeddedPostsPreferencesElement = function FacebookEmbeddedPostsPreferencesElement(view,
      opts) {
