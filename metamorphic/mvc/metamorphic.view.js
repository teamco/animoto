...
defineP([
...
], function defineMetamorphicView(BaseView, Header, Footer, MetamorphicElement,
    MetamorphicPreferencesElement, MetamorphicRulesElement) {
  ...
  return MetamorphicView.extend('MetamorphicView', {
     ...
     * Render Prefs
     * @memberOf MetamorphicView
     * @returns {MetamorphicPreferencesElement|boolean}
     */
