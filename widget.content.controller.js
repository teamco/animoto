...
defineP([
  ...
  return WidgetContentController.extend(
      'WidgetContentController', {
         ...
         * @param {boolean} [save]
         */
        alternativeSavePreferences: function alternativeSavePreferences(key,
            value, save) {
        ...
        isMetamorphic: function isMetamorphic() {
          ...
          return $container.isMetamorphicElement() &&
              !$element.isMetamorphicElement();
        },
        ...
        fetchGalleryWidgets: function fetchGalleryWidgets(prefs) {
          ...
          try {
             ...
             * @type {Gallery}
             */
            var gallery = pageData.controller.getContainment().controller.
                getGallery();
            ...
            prefs.metamorphicType.list = $.map(
                ...
                function _loadWidget(widget) {
                  ...
                  if (widget.resource !== 'metamorphic' &&
                      !widget.is_external) {
