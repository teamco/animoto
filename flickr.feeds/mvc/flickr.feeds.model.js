        ...
        list: [
          {
            ...
            query: 'tags', // (Optional) A comma delimited list of tags to
                           // filter the feed by
          ...
          },
          {
            ...
            query: 'user_id', // (Required) A single user ID. This specifies a
                              // user to fetch for
          ...
          },
          {
            ...
            query: 'user_id', // (Required) The user ID of the user to fetch
                              // friends photos and videos for
          ...
          },
          {
            ...
            query: 'id', // (Required) A single user ID. This specifies a user
                         // to fetch for
